...
function CleanTraces {
    Write-Host "`n`nCleaning files from the Check..." -ForegroundColor yellow
            ...
            do {
                ...
                switch ($checksChoice) {
                    1 {
                        ...
                        Get-ChildItem -Path "C:\Temp\Scripts" -File | Where-Object { $_.Name -ne "Menu.ps1" } | ForEach-Object { Remove-Item -Path $_.FullName -Recurse -Force } | Out-Null
                        $urls = @(
                            "https://raw.githubusercontent.com/Onexion/PC-Check-V2/main/PCCheck.ps1",
                            "https://raw.githubusercontent.com/Onexion/PC-Check-V2/main/MFT.ps1",
                            "https://raw.githubusercontent.com/Onexion/PC-Check-V2/main/Registry.ps1",
                            "https://raw.githubusercontent.com/Onexion/PC-Check-V2/main/SystemLogs.ps1",
                            "https://raw.githubusercontent.com/Onexion/PC-Check-V2/main/ProcDump.ps1",
                            "https://raw.githubusercontent.com/Onexion/PC-Check-V2/main/Localhost.ps1",
                            "https://raw.githubusercontent.com/Onexion/PC-Check-V2/main/Viewer.html"
                        )
                    ...
                    2 {
                        ...
                        New-Item -Path "C:\Temp\Dump" -ItemType Directory -Force | Out-Null
                        Set-Location "C:\temp"
                        Invoke-WebRequest -Uri "https://raw.githubusercontent.com/Onexion/Powershell-Skripts/main/RecordingChecker.ps1" -OutFile "C:\Temp\Scripts\RecordingChecker.ps1"
                        Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass -Force
                        Set-ExecutionPolicy -Scope LocalMachine -ExecutionPolicy RemoteSigned -Force
                        Add-MpPreference -ExclusionPath 'C:\Temp' | Out-Null
                        & C:\temp\scripts\RecordingChecker.ps1
                        Start-Sleep 3
